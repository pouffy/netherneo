...
public class ClientEffectEvents {
    ...
    public static void onPlayerTick(PlayerTickEvent.Post event) {
        ...
        if (player.hasEffect(NetherExp.MANIPULATION_EFFECT)) {

            
            if (whisperSound == null || whisperSound.isStopped()) {
                whisperSound = new ZoneAmbientSoundInstance(ModSounds.WHISPER.get(), player, NetherExp.MANIPULATION_EFFECT, true);
    ...
    public static void onMovementInput(MovementInputUpdateEvent event) {
        ...
        if (player == null || !player.hasEffect(NetherExp.MANIPULATION_EFFECT)) return;
