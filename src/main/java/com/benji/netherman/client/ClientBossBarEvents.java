...
public class ClientBossBarEvents {
    ...
    private static final ResourceLocation FRAME_TEXTURE = ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "textures/gui/azazel_frame.png");
    private static final ResourceLocation PROGRESS_TEXTURE = ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "textures/gui/azazel_progress.png");
    private static final ResourceLocation SUN_TEXTURE = ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "textures/gui/azazel_frame_sun.png"); 
    private static final ResourceLocation CINEMATIC_TEXTURE = ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "textures/gui/cinematic.png");
    private static final ResourceLocation SUN_LOWHP_TEXTURE = ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "textures/gui/azazel_frame_sun_lowhp.png");
