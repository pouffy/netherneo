...
public class TraderEntity extends PathfinderMob implements GeoEntity {
    ...
    public static final ResourceKey<LootTable> GOLD_TRADE_LOOT = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "gameplay/trader_gold"));
    public static final ResourceKey<LootTable> DIAMOND_TRADE_LOOT = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "gameplay/trader_diamond"));
    public static final ResourceKey<LootTable> NETHERITE_TRADE_LOOT = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(NetherExp.MODID, "gameplay/trader_netherite"));
